...
#' @param dotconnect whether to simply dot connect the readings for each curv
...
ms_ITTR_ggplotting <- function(data, legenddata=NULL, levelvector=NULL, nread=10,
                               ...
                               orderET=FALSE, orderAUC=FALSE, orderRep=FALSE, plotseq=NULL,
                               barplotformat=FALSE, witherrorbar=FALSE, usegradient=TRUE,
                               loess=FALSE, dotconnect=FALSE, pfdatabase=FALSE,
                               printBothName=TRUE, printGeneName=FALSE, printcount=FALSE, unit="min",
