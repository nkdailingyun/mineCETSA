...
## ----eval=FALSE----------------------------------------------------------
#  ITDRdata_f <- ms_ITDR_fitting(ITDRdata_s, calMDT=TRUE)
#  ITTRdata_f <- ms_ITTR_fitting(ITTRdata_s)
...
#  # Here the subfolder_name refer to the first level folder name under current working directory in which the data file locates
